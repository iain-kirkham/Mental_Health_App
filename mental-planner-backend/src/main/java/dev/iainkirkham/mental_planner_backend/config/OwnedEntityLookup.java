 ...
 * repeated across every feature service (tasks, time entries, mood entries).
 * <p>
 * This is for a service verifying ownership of <i>its own</i> entity. A service that only
 * references another domain's entity by ID (e.g. a time entry linking to a Task) doesn't use this
