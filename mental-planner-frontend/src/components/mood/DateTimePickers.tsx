    ...
    <div className="flex gap-2">
      <Popover>
        <PopoverTrigger asChild>
          <Button variant="outline" className="flex justify-start items-center w-full" disabled={isSubmitting} aria-label="Select date">
      ...
      <Popover>
        <PopoverTrigger asChild>
          <Button variant="outline" className="flex justify-start items-center" disabled={isSubmitting} aria-label="Select time">
